...
udpServerAddr = ('192.168.100.157', 6868) # replace with your network address, it usually 192.168.1.255 (255 in this case means broadcast)
...
#      print("use default model")
  ...
  def do_canny(frame, *args, **kwargs):
...
#        self.frame = frame[:,:,::-1].copy()
        print('{}'.format(self.frame))
        self.frame = self.do_canny(self.frame)
